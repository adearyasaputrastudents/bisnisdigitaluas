...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <!-- Link untuk mencetak kuitansi -->
            <?php if ($this->session->flashdata('receipt_url')): ?>
                <a href="<?= $this->session->flashdata('receipt_url') ?>" class="btn btn-success btn-sm"><i class="fas fa-print"></i> Cetak Kuitansi</a>
            <?php endif; ?>
        </div>
    </div>
</div>
